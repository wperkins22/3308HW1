...
function begin_play(){
	if (started) {
		...
		started = true;
		if (started) {
			if (whose_move() == 1) var activePlayer = "X";
			else var activePlayer = "O";
			activePlayer = activePlayer.bold();
			document.getElementById("turn_info").innerHTML = "Turn for: " + activePlayer;
		}
	}
...
function play() {
	if (started) {
		...
		var targCell = document.getElementById("move_text_id").value;
		if (table_ids.includes(targCell) && document.getElementById(targCell).innerHTML == targCell) {
			document.getElementById(targCell).innerHTML = activePlayer;

			var gameWon = false;
			if (targCell == "A1") {
				if (activePlayer == "X") board_state[0] = 1;
				else board_state[0] = 0;

				if ((board_state[0] == board_state[1] && board_state[1] == board_state[2]) || (board_state[0] == board_state[3] && board_state[3] == board_state[6]) || (board_state[0] == board_state[4] && board_state[4] == board_state[8])) {
					gameWon = true;
				}
			}
			else if (targCell == "A2") {
				if (activePlayer == "X") board_state[1] = 1;
				else board_state[1] = 0;

				if ((board_state[0] == board_state[1] && board_state[1] == board_state[2]) || (board_state[1] == board_state[4] && board_state[4] == board_state[7])) {
					gameWon = true;
				}
			}
			else if (targCell == "A3") {
				if (activePlayer == "X") board_state[2] = 1;
				else board_state[2] = 0;

				if ((board_state[0] == board_state[1] && board_state[1] == board_state[2]) || (board_state[2] == board_state[5] && board_state[5] == board_state[8]) || (board_state[2] == board_state[4] && board_state[4] == board_state[6])) {
					gameWon = true;
				}
			}
			else if (targCell == "B1") {
				if (activePlayer == "X") board_state[3] = 1;
				else board_state[3] = 0;

				if ((board_state[3] == board_state[4] && board_state[4] == board_state[5]) || (board_state[0] == board_state[3] && board_state[3] == board_state[6])) {
					gameWon = true;
				}
			}
			else if (targCell == "B2") {
				if (activePlayer == "X") board_state[4] = 1;
				else board_state[4] = 0;

				if ((board_state[3] == board_state[4] && board_state[4] == board_state[5]) || (board_state[1] == board_state[4] && board_state[4] == board_state[7]) || (board_state[0] == board_state[4] && board_state[4] == board_state[8]) || (board_state[2] == board_state[4] && board_state[4] == board_state[6])) {
					gameWon = true;
				}
			}
			else if (targCell == "B3") {
				if (activePlayer == "X") board_state[5] = 1;
				else board_state[5] = 0;

				if ((board_state[3] == board_state[4] && board_state[4] == board_state[5]) || (board_state[2] == board_state[5] && board_state[5] == board_state[8])) {
					gameWon = true;
				}
			}
			else if (targCell == "C1") {
				if (activePlayer == "X") board_state[6] = 1;
				else board_state[6] = 0;

				if ((board_state[6] == board_state[7] && board_state[7] == board_state[8]) || (board_state[0] == board_state[3] && board_state[3] == board_state[6]) || (board_state[2] == board_state[4] && board_state[4] == board_state[6])) {
					gameWon = true;
				}
			}
			else if (targCell == "C2") {
				if (activePlayer == "X") board_state[7] = 1;
				else board_state[7] = 0;

				if ((board_state[6] == board_state[7] && board_state[7] == board_state[8]) || (board_state[1] == board_state[4] && board_state[4] == board_state[7])) {
					gameWon = true;
				}
			}
			else {
				if (activePlayer == "X") board_state[8] = 1;
				else board_state[8] = 0;

				if ((board_state[6] == board_state[7] && board_state[7] == board_state[8]) || (board_state[2] == board_state[5] && board_state[5] == board_state[8]) || (board_state[0] == board_state[4] && board_state[4] == board_state[8])) {
					gameWon = true;
				}
			}
			if (gameWon) {
				...
				toggle_move();
				if (whose_move() == 1) activePlayer = "X";
				else activePlayer = "O";
				activePlayer = activePlayer.bold();
				document.getElementById("turn_info").innerHTML = "Turn for: " + activePlayer;
			}
			...
			alert("Please enter a valid cell ID.");
			return;
		}
	}
	else {
